...
public class LoginSteps {
    ...
    public void loginCredentialsWithAWrongPassword() {
        ...
        doThrow(
                ...
                .login(any(CredentialsDTO.class));
    }
    ...
    public void theLoginRequestIsSent()
            throws Exception {
    ...
    public void theLoginResponseStatusShouldBe(
            int expectedStatus) {
    ...
    public void aJwtTokenShouldBeReturned()
        ...
        assertThat(response.get("token").asText())
                .isEqualTo("jwt-token");
